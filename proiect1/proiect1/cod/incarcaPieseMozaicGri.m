function params = incarcaPieseMozaicGri(params)
...
filelist = dir([params.numeDirector '/*.png']);
for i = 1:length(filelist)
    imgName = [params.numeDirector  filelist(i).name];
    pieseMozaic(:,:,i) = rgb2gray(imread(imgName));
end;
